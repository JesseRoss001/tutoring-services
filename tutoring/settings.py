...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'tutoring1-2a2a70348a6b.herokuapp.com', 'northwalestutoring.com', 'www.northwalestutoring.com']

# CSRF Trusted Origins adds the HTTP origins that are trusted to send the CSRF token.
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000', 'http://localhost:8000', 'https://tutoring1-2a2a70348a6b.herokuapp.com', 'https://northwalestutoring.com', 'https://www.northwalestutoring.com']
